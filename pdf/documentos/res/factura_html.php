        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    &copy; <?php echo "www.copacabanatextil.com "; echo  $anio=date('Y'); ?>
                </td>
            </tr>
        </table>
    </page_footer>
...
$insert=mysqli_query($con,"INSERT INTO facturas VALUES ('','$numero_factura','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura','2')");

if($_tipo == 2){
    
    $insert2 = mysqli_query($con,"INSERT INTO `cuentas_por_cobrar` ( `id_cliente`, `monto_cpc`, `documento`, `fecha_reg`) VALUES ( '$id_cliente', '$total_factura', '$numero_factura', '$date')");
