<?php
	...
	if (empty($_POST['mod_id'])) {
           ...
           $errors[] = "Nombre vacío";
        }  else if ($_POST['mod_rfc']==""){
			$errors[] = "Ingrese el RFC del cliente, por favor";
		}  else if (
			!empty($_POST['mod_id']) &&
		...
		$sql="UPDATE `clientes` SET `nombre_cliente` = '$nombre', `telefono_cliente` = '$telefono', `email_cliente` = '$email', `direccion_cliente` = '$direccion', `rfc` = '$rfc', `contacto` = '$contacto' WHERE `clientes`.`id_cliente` = '$id_cliente'";
