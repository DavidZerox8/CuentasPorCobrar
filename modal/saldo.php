	    ...
	    <div class="modal-dialog" role="document">
	        <div class="modal-content">
	            <div class="modal-header">
	                ...
	                <h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-zoom-in'></i> Reporte de saldos</h4>
	            </div>
	            <div class="modal-body">
                <!-- Inicio del formulario -->
	                <form action="./reporte_s.php" class="form-horizontal" method="post" id="documentar_facturas" name="documentar_facturas" target="_blank">
                        ...
                        <!-- Inputs para las fechas en caso de que requieran.
