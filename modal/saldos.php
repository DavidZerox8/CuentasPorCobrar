	...
	?>
	<!-- Modal -->
	<div class="modal fade" id="saldos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	    <div class="modal-dialog" role="document">
	        <div class="modal-content">
	            <div class="modal-header">
	                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	                <h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-zoom-in'></i> Antig&uuml;edad de Saldos</h4>
	            </div>
	            <div class="modal-body">
	                <form action="./saldos.php" class="form-horizontal" method="post" id="documentar_facturas" name="documentar_facturas" target="_blank">
