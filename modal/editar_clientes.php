	        ...
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                ...
	                <form class="form-horizontal" method="post" id="editar_cliente" name="editar_cliente">
	                    ...
	                    <div class="form-group">
	                        <label for="mod_direccion" class="col-sm-3 control-label">RFC</label>
	                        <div class="col-sm-8">
	                            <input type="text" class="form-control" id="mod_rfc" name="mod_rfc" required>
	                        </div>
	                    </div>
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-sm-8">
	                            <input maxlength="3" type="number" class="form-control" id="mod_credito" name="mod_credito" required>
	                        </div>
	                    </div>

	                    <div class="form-group">
	                        <label for="mod_email" class="col-sm-3 control-label">Contacto</label>
	                        <div class="col-sm-8">
